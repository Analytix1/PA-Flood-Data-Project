...
The data set for this research comes from the United States Geological Survey and FEMA's flood data release for Pennsylvania. The data can be found here: [Flood Data Collection in Pennsylvania](Flood Data Collection in Pennsylvania – Site Selection Data for the Development of a Rapid Deployment Network | U.S. Geological Survey (usgs.gov)
...
**ScoCritVar:** Scour critical bridge indicator.

[SCBI Guide](Scour-Calculator-Manual.pdf (state.pa.us)
...
**SVIVar:** Social Vulnerability Index
